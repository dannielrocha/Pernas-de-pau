...
public class OuvinteDoTeclado extends KeyAdapter {
	...
	public OuvinteDoTeclado(CommandExecutor game) {
		this.game = game;
	}
	...
	private Map<Integer, Comando> loadComandos() {
		...
		map.put(KeyEvent.VK_UP, Comando.MOVE_UP);
		map.put(KeyEvent.VK_DOWN, Comando.MOVE_DOWN);
		map.put(KeyEvent.VK_LEFT, Comando.MOVE_LEFT);
		map.put(KeyEvent.VK_RIGHT, Comando.MOVE_RIGHT);
		...
		map.put(KeyEvent.VK_ESCAPE, Comando.DESCONECTAR);
